...
import './PopulateSection.css';

import { Autoplay, Pagination } from 'swiper/modules';


export default function PopulateSection({ populateProducts }) {
        ...
        <>
            <section className="trending">
                <div className="container">
                    ...
                    <HeaderSection title="محبوب ترین محصولات"/>
                    <div className="trending__slider">
                        ...
                        >
                            {populateProducts.map((product,index) => (
